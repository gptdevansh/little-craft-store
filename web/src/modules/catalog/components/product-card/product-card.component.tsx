...
export function ProductCard({ product, aspectRatio = 'square' }: ProductCardProps) {
  ...
  return (
    <article className="flex flex-col h-full justify-between group">
      <div>
        {/* Image */}
        <div
        ...
        >
          ...
          {product.badge && (
            <div
              className="absolute top-3 left-3 bg-sage-green text-white p-1.5 rounded-full flex items-center justify-center shadow-sm"
              title={product.badge}
            >
              <Icon
        ...
        <div className="flex justify-between items-baseline mb-2 gap-2">
          <h3 className="font-[family-name:var(--font-headline)] text-[16px] md:text-[18px] text-on-surface font-medium leading-snug">
            {product.name}
          </h3>
          <span className="font-[family-name:var(--font-body)] text-[15px] tracking-[0.03em] font-semibold text-primary shrink-0">
            ₹{product.price}
          </span>
        </div>
        <p className="font-[family-name:var(--font-body)] text-[13px] md:text-[14px] text-on-surface-variant mb-4 leading-relaxed line-clamp-2">
          {product.description}
        </p>
      </div>
      ...
      <a
        ...
        className="btn-whatsapp w-full py-3 rounded-full font-[family-name:var(--font-body)] text-[13px] tracking-[0.03em] font-semibold flex items-center justify-center gap-2 min-h-[var(--spacing-touch-target)] mt-auto shadow-sm"
      >
